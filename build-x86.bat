...
rem Add UPX
IF EXIST upx.exe upx "%cd%\target\i686-pc-windows-msvc\release\Appender.exe" --best --compress-resources=0 --strip-relocs=0 --compress-icons=0 --compress-exports=0 --lzma
